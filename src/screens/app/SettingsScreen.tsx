        ...
        <Animated.View style={[{ gap: 24 }, contentAnim]}>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.helper}>
              Permanently deletes your account, the capsules you own, and your votes. This can't be undone.
            </Text>
          </View>
      ...
      <Pressable style={styles.backdrop} onPress={busy ? () => {} : onClose}>
        <Pressable style={styles.sheet} onPress={() => {}}>
          ...
          <Text style={styles.sheetBody}>
            This permanently deletes your profile, the capsules you own, your votes, and all related notifications. This cannot be undone.
          </Text>
